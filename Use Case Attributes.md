...
Input data is quantifiable
There is a High volume of input data
input data is Non-destructive 
Inputs and Outputs can form a fast loop
Input data is fresh, structured and consistent (i.e. not conflicting)
Policy and Rules are exact and easy to follow
Input data is multi-source
